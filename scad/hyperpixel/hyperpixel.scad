    ...
    move([0,0,11.5]) {
        move([-12,0.5 - 2,0]) {
            ...
            difference() {
                ...
                color([0.1,0.1,0.1]) move([7,(58.5 - 51.8) / 2,12.5]) cuboid([86.4, 51.8, 0.6], center=false);
            }

            // Actual screen is 86.4x51.8mm
            // offset is 7x3
            color([0.2,0.2,0.2]) move([7,(58.5 - 51.8) / 2,12.5]) cuboid([86.4, 51.8, 0.5], center=false);
